...
public class Board extends JPanel {
	...
	private void initializeSquares() {
		...
		square04.setPrice(120);
                ...
                Group_Property grupoAzul= new Group_Property("azul");
                grupoAzul.agregarPropiedad( square01);
                grupoAzul.agregarPropiedad( square03);
                grupoAzul.agregarPropiedad( square04);
		
		square06.setPrice(140);
		square08.setPrice(140);
		square09.setPrice(160);
                
                Group_Property gruporojo= new Group_Property("rosa");
                grupoAzul.agregarPropiedad(square06);
                grupoAzul.agregarPropiedad(square08);
                grupoAzul.agregarPropiedad( square09);
		
		square11.setPrice(180);
		square13.setPrice(180);
		square14.setPrice(200);
                
                Group_Property grupoamarillo= new Group_Property("amarilo");
                grupoAzul.agregarPropiedad(square11);
                grupoAzul.agregarPropiedad(square13);
                grupoAzul.agregarPropiedad( square14);
                
                square16.setPrice(220);
		square17.setPrice(240);
		square19.setPrice(260);
                
                Group_Property grupoverde= new Group_Property("verde");
                grupoAzul.agregarPropiedad(square11);
                grupoAzul.agregarPropiedad(square13);
                grupoAzul.agregarPropiedad( square14);
